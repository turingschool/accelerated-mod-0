...
Instance methods are methods defined by the developer within a class definition, that can be called on any existing instance object of that class. What follows is an example to illustrate the syntax:
